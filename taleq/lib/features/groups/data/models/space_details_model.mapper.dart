...
class SpaceDetailsMapper extends ClassMapperBase<SpaceDetails> {
  ...
  static const Field<SpaceDetails, String> _f$channelName =
      Field('channelName', _$channelName);
  static DateTime _$startDate(SpaceDetails v) => v.startDate;
  static const Field<SpaceDetails, DateTime> _f$startDate =
      Field('startDate', _$startDate);
  static DateTime _$endDate(SpaceDetails v) => v.endDate;
  static const Field<SpaceDetails, DateTime> _f$endDate =
      Field('endDate', _$endDate);
  static int _$numberOfSeats(SpaceDetails v) => v.numberOfSeats;
  static const Field<SpaceDetails, int> _f$numberOfSeats =
      Field('numberOfSeats', _$numberOfSeats);
  static int _$numberOfPepole(SpaceDetails v) => v.numberOfPepole;
  static const Field<SpaceDetails, int> _f$numberOfPepole =
      Field('numberOfPepole', _$numberOfPepole);
  static String _$description(SpaceDetails v) => v.description;
  static const Field<SpaceDetails, String> _f$description =
      Field('description', _$description);
  static List<String> _$goals(SpaceDetails v) => v.goals;
  static const Field<SpaceDetails, List<String>> _f$goals =
      Field('goals', _$goals);
...
mixin SpaceDetailsMappable {
  String toJson() {
    return SpaceDetailsMapper.ensureInitialized()
        .encodeJson<SpaceDetails>(this as SpaceDetails);
  }

  Map<String, dynamic> toMap() {
    return SpaceDetailsMapper.ensureInitialized()
        .encodeMap<SpaceDetails>(this as SpaceDetails);
  }
  ...
  SpaceDetailsCopyWith<SpaceDetails, SpaceDetails, SpaceDetails> get copyWith =>
      _SpaceDetailsCopyWithImpl<SpaceDetails, SpaceDetails>(
          this as SpaceDetails, $identity, $identity);
  @override
  String toString() {
    return SpaceDetailsMapper.ensureInitialized()
        .stringifyValue(this as SpaceDetails);
  }

  @override
  bool operator ==(Object other) {
    return SpaceDetailsMapper.ensureInitialized()
        .equalsValue(this as SpaceDetails, other);
  }

  @override
  int get hashCode {
    return SpaceDetailsMapper.ensureInitialized()
        .hashValue(this as SpaceDetails);
  }
}
...
class _SpaceDetailsCopyWithImpl<$R, $Out>
  ...
  @override
  ListCopyWith<$R, String, ObjectCopyWith<$R, String, String>> get goals =>
      ListCopyWith($value.goals, (v, t) => ObjectCopyWith(v, $identity, t),
          (v) => call(goals: v));
  @override
  $R call(
          {String? id,
