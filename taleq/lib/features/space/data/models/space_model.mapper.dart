...
class SpaceListsModelMapper extends ClassMapperBase<SpaceListsModel> {
  ...
  static const Field<SpaceListsModel, String> _f$channelName =
      Field('channelName', _$channelName);
  static String _$hostID(SpaceListsModel v) => v.hostID;
  static const Field<SpaceListsModel, String> _f$hostID =
...
mixin SpaceListsModelMappable {
  ...
  Map<String, dynamic> toMap() {
    return SpaceListsModelMapper.ensureInitialized()
        .encodeMap<SpaceListsModel>(this as SpaceListsModel);
  }
  ...
  SpaceListsModelCopyWith<SpaceListsModel, SpaceListsModel, SpaceListsModel>
      get copyWith =>
          _SpaceListsModelCopyWithImpl<SpaceListsModel, SpaceListsModel>(
              this as SpaceListsModel, $identity, $identity);
  @override
  String toString() {
    return SpaceListsModelMapper.ensureInitialized()
        .stringifyValue(this as SpaceListsModel);
  }

  @override
  bool operator ==(Object other) {
    return SpaceListsModelMapper.ensureInitialized()
        .equalsValue(this as SpaceListsModel, other);
  }

  @override
  int get hashCode {
    return SpaceListsModelMapper.ensureInitialized()
        .hashValue(this as SpaceListsModel);
  }
}
...
abstract class SpaceListsModelCopyWith<$R, $In extends SpaceListsModel, $Out>
  ...
  ListCopyWith<$R, Map<String, dynamic>,
      ObjectCopyWith<$R, Map<String, dynamic>, Map<String, dynamic>>> get users;
  ListCopyWith<$R, Map<String, dynamic>,
...
class _SpaceListsModelCopyWithImpl<$R, $Out>
  ...
  ListCopyWith<$R, Map<String, dynamic>,
          ObjectCopyWith<$R, Map<String, dynamic>, Map<String, dynamic>>>
      get users => ListCopyWith($value.users,
          (v, t) => ObjectCopyWith(v, $identity, t), (v) => call(users: v));
  @override
  ListCopyWith<$R, Map<String, dynamic>,
          ObjectCopyWith<$R, Map<String, dynamic>, Map<String, dynamic>>>
      get comments => ListCopyWith($value.comments,
          (v, t) => ObjectCopyWith(v, $identity, t), (v) => call(comments: v));
  @override
  $R call(
          {String? id,
          String? name,
