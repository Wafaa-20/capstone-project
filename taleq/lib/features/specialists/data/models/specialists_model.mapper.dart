...
class SpecialistsModelMapper extends ClassMapperBase<SpecialistsModel> {
  ...
  static const Field<SpecialistsModel, String> _f$image = Field(
    'image',
    _$image,
  );
  ...
  static const Field<SpecialistsModel, String> _f$subtitle = Field(
    'subtitle',
    _$subtitle,
  );
  static double _$rating(SpecialistsModel v) => v.rating;
  static const Field<SpecialistsModel, double> _f$rating = Field(
    'rating',
    _$rating,
  );
  static List<String> _$description(SpecialistsModel v) => v.description;
  static const Field<SpecialistsModel, List<String>> _f$description = Field(
    'description',
    _$description,
  );
...
mixin SpecialistsModelMappable {
  ...
  get copyWith =>
      _SpecialistsModelCopyWithImpl<SpecialistsModel, SpecialistsModel>(
        this as SpecialistsModel,
        $identity,
        $identity,
      );
  @override
  String toString() {
    return SpecialistsModelMapper.ensureInitialized().stringifyValue(
      this as SpecialistsModel,
    );
  }
  ...
  bool operator ==(Object other) {
    return SpecialistsModelMapper.ensureInitialized().equalsValue(
      this as SpecialistsModel,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return SpecialistsModelMapper.ensureInitialized().hashValue(
      this as SpecialistsModel,
    );
  }
}
...
extension SpecialistsModelValueCopy<$R, $Out>
  ...
  get $asSpecialistsModel =>
      $base.as((v, t, t2) => _SpecialistsModelCopyWithImpl<$R, $Out>(v, t, t2));
}
